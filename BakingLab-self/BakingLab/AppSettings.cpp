...
namespace AppSettings
{
    ...
    void Initialize(ID3D11Device* device)
    {
        ...
        SkyMode.Initialize(tweakBar, "SkyMode", "Sky", "Sky Mode", "Controls the sky used for GI baking and background rendering", SkyModes::None, 6, SkyModesLabels);
        ...
        BakeMode.Initialize(tweakBar, "BakeMode", "Baking", "Bake Mode", "The current encoding/basis used for baking light map sample points", BakeModes::SG12, 12, BakeModesLabels);
